...
class QuestionsData {
  ...
  static List<String> get categories {
    final values = flutterQuestions.map((q) => q.category).toSet().toList()
      ..sort();
    return values;
  }

  static List<Question> filter({String? category, Difficulty? difficulty}) {
    return flutterQuestions.where((q) {
      final matchesCategory = category == null || q.category == category;
